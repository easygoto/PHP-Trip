...
window.onload = function () {
    ...
    canvas.onmousemove = function (ev) {
        ...
        balls.push({
            px: oEvent.offsetX,
            py: oEvent.offsetY,
            vx: getRandom(0, 1) === 0 ? getRandom(-MAX_SPEED_X, -MIN_SPEED_X) : getRandom(MIN_SPEED_X, MAX_SPEED_X),
            vy: getRandom(0, 1) === 0 ? getRandom(-MAX_SPEED_Y, -MIN_SPEED_Y) : getRandom(MAX_SPEED_Y, MIN_SPEED_Y),
